<?php 
    ...
    class perfiles extends utilidades{
        ...
        public function getperfiles($params=null){
            ...
            if($_SESSION['permisos'][$this->id_modulo]['r']){
                    ...
                    if($id_perfil>0){
                        ...
                        while($perfiles = $result->fetch_assoc()){
                            ...
                            if($_SESSION['usuario']['perfil_id']==1){
                                $btnPermisos = '<button class="btn btn-icon btn-primary btn-sm btn_permisos" onclick="editarPermisos('.$perfiles['id_perfil'].')" data-id_perfil="'.$perfiles['id_perfil'].'" ><i class="ki-solid ki-lock fs-1"></i></button>';
                            }
                            if($_SESSION['permisos'][$this->id_modulo]['u']){
                                $btnEdit = '<button class="btn btn-icon btn-primary btn-sm btn_editar" onclick="editarRol('.$perfiles['id_perfil'].')" data-id_perfil="'.$perfiles['id_perfil'].'" ><i class="ki-solid ki-notepad-edit fs-1"></button>';
                            }
                ...
                $codigo = "PERMISOS";
                $mensaje = "Sin permisos par este modulo";
